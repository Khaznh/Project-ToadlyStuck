...
public class LV21Info : LVInfo
{
    public void OnEnable()
    {
        PlayerPrefs.SetInt("LastLevelPlayed", 21);
        PlayerController.Instance.playerMovement.curseGravity = true;
    }

    private void OnDisable()
    {
        PlayerController.Instance.playerMovement.curseGravity = false;
    ...
    public void OnPlayerNextLevel(Collider2D collision, Activer activer)
    {
        ...
        LevelUnlockManager.Instance.UnlockNextLevel(22);
