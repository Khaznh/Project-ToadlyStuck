...
public class LV2Info : LVInfo
{
    [SerializeField] private int timesToPressButtonToOpen = 3;
    ...
    public void OnPlayerNextLevel(Collider2D collision, Activer activer)
    {
        ...
        LevelUnlockManager.Instance.UnlockNextLevel(3);
    ...
    private void PressButton(GameObject pressGO)
    {
        ...
        timesPlayerPressButton++;

        if (timesPlayerPressButton < timesToPressButtonToOpen)
        {
            return;
        }
