...
public class LV24Info : LVInfo
{
    public void OnEnable()
    {
        PlayerPrefs.SetInt("LastLevelPlayed", 24);
        PlayerController.Instance.playerMovement.isHopHop = true;
    }

    private void OnDisable()
    {
        PlayerController.Instance.playerMovement.isHopHop = false;
    }
    ...
    public void OnPlayerNextLevel(Collider2D collision, Activer activer)
    {
        ...
        LevelUnlockManager.Instance.UnlockNextLevel(25);
