...
public class LV23Info : LVInfo
{
    public void OnEnable()
    {
        PlayerPrefs.SetInt("LastLevelPlayed", 23);
        PlayerController.Instance.playerMovement.isHighPing = true;
    }

    private void OnDisable()
    {
        PlayerController.Instance.playerMovement.isHighPing = false;
    }
    ...
    public void OnPlayerNextLevel(Collider2D collision, Activer activer)
    {
        ...
        LevelUnlockManager.Instance.UnlockNextLevel(24);
